<template>
  <div class="dashboard">
    <span>{{formVal}}</span>
    <row>
      <el-form :model="formVal" :rules="rules" ref="create">
        <el-form-item v-for="item in formVal" label="分组名" :label-width="formLabelWidth"  prop="name">
        ...
        <el-form-item class="text-center">
          <el-button @click="btnCacel(1)" type="primary">保存</el-button>
